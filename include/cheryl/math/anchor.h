...
namespace CE {
    ...
    namespace math {
        ...
        struct Anchor {
            static void MakePivot(Pivot pivot, float* vertices,
                                  std::uint32_t texture_width, std::uint32_t texture_height,
                                  std::uint32_t width, std::uint32_t height,
                                  std::uint32_t x0 = 0, std::uint32_t y0 = 0);
            static void MakePivot(Pivot pivot, Vertex2D* vertices,
                                  std::uint32_t texture_width, std::uint32_t texture_height,
                                  std::uint32_t width, std::uint32_t height,
                                  std::uint32_t x0 = 0, std::uint32_t y0 = 0);

            static void MakeAnchor(AnchorType type, float* vertices,
                                   std::uint32_t texture_width, std::uint32_t texture_height,
                                   std::uint32_t width, std::uint32_t height,
                                   std::uint32_t x0 = 0, std::uint32_t y0 = 0);
            static void MakeAnchor(AnchorType type, Vertex2D* vertices,
                                   std::uint32_t texture_width, std::uint32_t texture_height,
                                   std::uint32_t width, std::uint32_t height,
                                   std::uint32_t x0 = 0, std::uint32_t y0 = 0);
